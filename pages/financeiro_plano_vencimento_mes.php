...
$sql = "SELECT u.id, u.nome, u.datafim, u.img_id, p.ciclo
        ...
        AND DATE_FORMAT(u.datafim, '%Y-%m') = '$currentMonth'
        AND p.ciclo IN ('trimestral', 'semestral', 'anual')";
            ...
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col-lg-6 col-7">
                        <h4>Planos vencendo ou vencidos</h4>
...
<?php 
// Primeiro, obtenha o próximo mês
...
$sql = "SELECT u.id, u.nome, u.datafim, u.img_id, p.ciclo
        ...
        INNER JOIN planos p ON u.id_plano = p.id
        WHERE u.id_conta = $id_Conta 
        AND DATE_FORMAT(u.datafim, '%Y-%m') = '$nextMonth'
        AND p.ciclo IN ('trimestral', 'semestral', 'anual')";
    ...
    <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
        <div class="card">
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col-lg-6 col-7">
                        <h4>Planos a vencer no próximo mês</h4>
                        <p class="text-sm mb-0"></p>
                    </div>
                    <div class="col-lg-6 col-5 my-auto text-end"></div>
                </div>
...
if (mysqli_num_rows($result) > 0) {
    while ($user_data = mysqli_fetch_assoc($result)) {
        ...
        $datafim_brasileiro = date('d/m/Y', strtotime($user_data['datafim']));
        echo "<td class='text-xs font-weight-bold mb-0'>$datafim_brasileiro</td>";
