<?php 
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <?php include ('../sql/cards_alunos.php');
      include ('../sql/lista_de_inativos.php');  ?>
                ...
                <div class="container">
                        <ul class="pagination">
                            ...
                            if ($paginaAtual > 1) {
                                ...
                                echo '<li class="page-item"><a class="page-link" href="alunos_inativos.php?page=' . $paginaAnterior . '">A</a></li>';
                            }
                            ...
                            for ($i = 1; $i <= $totalPaginas; $i++) {
                                ...
                                echo '"><a class="page-link" href="alunos_inativos.php?page=' . $i . '">' . $i . '</a></li>';
                            }

                            // Botão "Próxima"
                            if ($paginaAtual < $totalPaginas) {
                                $paginaSeguinte = $paginaAtual + 1;
                                echo '<li class="page-item"><a class="page-link" href="alunos_inativos.php?page=' . $paginaSeguinte . '">P</a></li>';
                            }
                            ?>
                        </ul>
                    </div>
