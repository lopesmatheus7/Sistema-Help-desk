<?php 
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <?php include ('../sql/cards_alunos.php');
      include ('../sql/professores/listaProfessores.php');  ?>
    
        <div class="modal fade" id="CadastroModal" tabindex="-1" role="dialog" aria-labelledby="CadastroModalLabel" aria-hidden="true">
              <?php 
                include '../modals/cadastro_colaboradores.php';
              ?>
            </div>
    </div>
            </div>
...
<div class="card-body px-0 pb-2">
    ...
    <tbody>
    <?php
    $query_usuarios = "SELECT * FROM colaboradores ORDER BY id DESC";
...
echo "<td><a class='btn bg-gradient-light' href='profile_colaborador.php?id={$user_data['id']}'>Painel do professor</a></td>"; 
                ...
                <div class="container">
                        <ul class="pagination">
                            ...
                            if ($paginaAtual > 1) {
                                ...
                                echo '<li class="page-item"><a class="page-link" href="gestao_colaboradores.php?page=' . $paginaAnterior . '">A</a></li>';
                            }
                            ...
                            for ($i = 1; $i <= $totalPaginas; $i++) {
                                ...
                                echo '"><a class="page-link" href="gestao_colaboradores.php?page=' . $i . '">' . $i . '</a></li>';
                            }

                            // Botão "Próxima"
                            if ($paginaAtual < $totalPaginas) {
                                $paginaSeguinte = $paginaAtual + 1;
                                echo '<li class="page-item"><a class="page-link" href="gestao_colaboradores?page=' . $paginaSeguinte . '">P</a></li>';
                            }
                            ?>
                        </ul>
                    </div>
