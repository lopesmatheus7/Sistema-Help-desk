<?php 
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
   ...
   <?php   include ('../sql/lista_da_turma.php');  ?>
...
<div class="card-body px-0 pb-2">
    ...
    <tbody>
    <?php
$query_usuarios = "SELECT usuarios.* 
                    FROM usuarios 
                    JOIN matriculas_horarios ON usuarios.id = matriculas_horarios.usuario_id
                    WHERE matriculas_horarios.id_turma = $id";

$result_usuarios = $conn->query($query_usuarios);

while ($user_data = mysqli_fetch_assoc($result_usuarios)) {
    echo "<tr>";
    ...
    echo "<td class='text-xs font-weight-bold mb-0'>{$user_data['responsavel']}</td>";
                ...
                <div class="container">
                        <ul class="pagination">
                            ...
                            if ($paginaAtual > 1) {
                                ...
                                echo '<li class="page-item"><a class="page-link" href="painel_turmas.php?page=' . $paginaAnterior . '">A</a></li>';
                            }
                            ...
                            for ($i = 1; $i <= $totalPaginas; $i++) {
                                ...
                                echo '"><a class="page-link" href="painel_turmas.php?page=' . $i . '">' . $i . '</a></li>';
                            }

                            // Botão "Próxima"
                            if ($paginaAtual < $totalPaginas) {
                                $paginaSeguinte = $paginaAtual + 1;
                                echo '<li class="page-item"><a class="page-link" href="painel_turmas.php?page=' . $paginaSeguinte . '">P</a></li>';
                            }
                            ?>
                        </ul>
