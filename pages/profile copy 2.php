        ...
        <div class="card h-100">
            ...
            <div class="card-body p-2">
                ...
                <div class="d-flex justify-content-between">
                    <button class="btn bg-gradient-info w-md-40 mt-4 mb-5 btn-xs btn-lg btn-block" data-bs-toggle="modal" data-bs-target="#cobrancaModal">NOVA COBRANÇA</button>
                    <button class="btn bg-gradient-warning w-md-40 mt-4 mb-5 btn-xs btn-sm btn-block" data-bs-toggle="modal" data-bs-target="#produtoModal" disabled>COBRANÇA DE PRODUTOS</button>
                </div>
