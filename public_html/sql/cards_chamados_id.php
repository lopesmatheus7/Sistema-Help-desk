<?php //// TOTAL DE USUÁRIOS DO SISTEMA 
$usuario_id = $_SESSION['id'];
$id_conta = $_SESSION['id_conta'];

$sql = "SELECT COUNT(*) AS total_chamados FROM chamados WHERE id_conta = $id_conta AND usuario_id = $usuario_id AND status = 'ABERTO'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $totalChamadosAbertosId = $row["total_chamados"];
    //echo "Total de chamados ABERTOS associados ao usuário com ID $usuario_id: $totalChamadosAbertos";
} else {
                ...
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder mb-0">
                      <?php echo $totalChamadosAbertosId ?>
