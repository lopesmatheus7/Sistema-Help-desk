  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <div class="tab-content mt-2">
          ...
          <div class="tab-pane fade" id="estoque">
            ...
            <div class="container-fluid">
              <h4>Conteúdo de Estoque</h4>
              <!-- Adicione o conteúdo específico de Estoque aqui -->
            </div>
          </div>
          <div class="tab-pane fade" id="dadosPessoais">
            <!-- Container para o conteúdo de Dados Pessoais -->
            <div class="container-fluid">
              <h4>Conteúdo de Dados Pessoais</h4>
        ...
        <table class="table">
            ...
            if ($result_chamados->num_rows > 0) {
                while ($row = $result_chamados->fetch_assoc()) {
                    ...
                    $tempoDecorridoHoras = $tempoDecorrido / 3600;

                    // Calcula a porcentagem de SLA
                    $slaHoras = 4;
                    $slaProgresso = ($tempoDecorridoHoras / $slaHoras) * 100;
                    $slaProgresso = min($slaProgresso, 100);

                    // Use uma classe CSS personalizada para definir a largura da barra
                    $barraStyle = 'width: ' . $slaProgresso . '%;';

                    echo "<td>";
                    echo '<div class="progress">';
                    echo '<div class="progress">';
                    echo '<div class="progress-bar" role="progressbar" style="width: ' . $slaProgresso . '%;" aria-valuenow="' . $slaProgresso . '" aria-valuemin="0" aria-valuemax="100"></div>';
                    echo '</div>';
        ...
        <div class="col-12 col-xl-4">
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              <p class="text-sm">
                Hi, I’m <?php echo $dadosUsuario['nome'] ?>, Decisions: If you can’t decide, the answer is no. If two equally difficult paths, choose the one more painful in the short term (pain avoidance is creating an illusion of equality).
              </p>
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Contato</strong> &nbsp; (44) 123 1234 123</li>
