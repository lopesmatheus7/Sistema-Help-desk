          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <img width="150px" src="assets/img/logos/HERCULES.png" alt="logo" srcset="">
                  <h3 class="font-weight-bolder text-info text-gradient">Seja bem vindo ao seu sistema de escolinhas de futebol</h3>
